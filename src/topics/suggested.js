...
function default_1(getTopicTags, getTopicsByTids, getTopicFields, getSortedSetRevRange, getSortedSetRevRangeByScore) {
    const getSuggestedTopics = function (tid, uid, start, stop, cutoff = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let topicData = yield getTopicsByTids(tids, uid);
    ...
    function getTidsWithSameTags(tid, cutoff) {
        return __awaiter(this, void 0, void 0, function* () {
            const tags = yield getTopicTags(tid);
            let tids = cutoff === 0 ?
                yield getSortedSetRevRange(tags.map((tag) => `tag:${tag}:topics`), 0, -1) :
                yield getSortedSetRevRangeByScore(tags.map((tag) => `tag:${tag}:topics`), 0, -1, '+inf', Date.now() - cutoff);
    ...
    function getSearchTids(tid, uid, cutoff) {
        return __awaiter(this, void 0, void 0, function* () {
            const topicData = yield getTopicFields(tid, ['title', 'cid']);
    ...
    function getCategoryTids(tid, cutoff) {
        return __awaiter(this, void 0, void 0, function* () {
            const cid = yield getTopicFields(tid, 'cid');
            const tids = cutoff === 0 ?
                yield getSortedSetRevRange(`cid:${cid}:tids:lastposttime`, 0, 9) :
                yield getSortedSetRevRangeByScore(`cid:${cid}:tids:lastposttime`, 0, 9, '+inf', Date.now() - cutoff);
