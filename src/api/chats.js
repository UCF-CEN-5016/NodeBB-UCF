...
const socketHelpers = __importStar(require("../socket.io"));
...
const chatsAPI = {
    ...
    rename(caller, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // The next line calls a function in a module that has not been updated to TS yet
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-return
            caller.uid = yield messaging.getUidsInRoom(data.roomId, 0, -1);
            // The next line calls a function in a module that has not been updated to TS yet
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-return
    ...
    invite(caller, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // The next line calls a function in a module that has not been updated to TS yet
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-return
            //await Promise.all(data.uids.map(async (uid: string) => messaging.canMessageUser(caller.uid, uid)));
            // The next line calls a function in a module that has not been updated to TS yet
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-return
