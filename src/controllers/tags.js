...
exports.tagsController.getTag = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [settings, cids, categoryData, isPrivileged] = yield Promise.all([
            user_1.default.getSettings(req.query.uid),
            cid || categories_1.default.getCidsByPrivilege('categories:cid', req.query.uid, 'topics:read'),
            helpers_1.default.getSelectedCategory(cid),
            user_1.default.isPrivileged(req.query.uid),
        ]);
        ...
        templateData.topics = yield topics_1.default.getTopics(tids, req.query.uid);
...
exports.tagsController.getTags = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const cids = yield categories_1.default.getCidsByPrivilege('categories:cid', req.query.uid, 'topics:read');
        const [canSearch, tags] = yield Promise.all([
            privileges_1.default.global.can('search:tags', req.query.uid),
