...
interface MyTagsController {
    getTag: (req: MyRequest, res: MyResponse) => Promise<void>;
    getTags: (req: MyRequest, res: MyResponse) => Promise<void>;
}
...
interface MyPaginationData {
    currentPage: number;
    pageCount: number;
    rel?: string[];
}

type MyPromiseResult = [
...
type MyPromiseResultTopic = [
    number,
    number[]
]

type MyPromiseResultMultTags = [
    boolean,
    string[]
]

const myTagsController: MyTagsController = {
    getTag: async function (req: MyRequest, res: MyResponse) {
        ...
        const templateData: MyTemplateData = {
            topics: [],
    ...
    getTags: async function (req: MyRequest, res: MyResponse) {
...
module.exports = myTagsController;
